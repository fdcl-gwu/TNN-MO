...
def cat_points(cat_id = 1):
    ...
    if cat_id == cat_names_to_id("dog house"): #1
        ...
        #print("Pw [{}] : dog house".format(cat_id))
        return P
    ...
    if cat_id == cat_names_to_id("dog house left"): #2
        ...
        #print("Pw [{}] : dog house left".format(cat_id))
        return P
    ...
    if cat_id == cat_names_to_id("dog house right"): #3
        ...
        #print("Pw [{}] : dog house right".format(cat_id))
        return P
    ...
    if cat_id == cat_names_to_id("dog house center"): #4
        ...
        P = np.array([[x1, y1, z1],[x2, y1, z2],[-x2, y1, z2],[-x1, y1, z1],[x1, y2, z1],[x2, y2, z2],[-x2, y2, z2],[-x1, y2, z1]])
        #print("Pw [{}] : dog house center".format(cat_id))
        return P
    ...
    if cat_id == cat_names_to_id("house long"): #6
        ...
        P = np.array([[x1, y1, z1],[x2, y1, z2],[-x2, y1, z2],[-x1, y1, z1],[x1, y2, z1],[x2, y2, z2],[-x2, y2, z2],[-x1, y2, z1]])
        #print("Pw [{}] : house long".format(cat_id))
        return P
    ...
    if cat_id == cat_names_to_id("whole ship"): #7
        ...
        #print("Pw [{}] : whole ship".format(cat_id))
        return P
        
    if cat_id == cat_names_to_id("super structure"): #8
        x1 = 3.33581
        x2 = 3.33581 
        y1 = 2.78005 
        y2 = 19.8254 
        ...
        #print("Pw [{}] : super structure".format(cat_id))
        return P
    ...
    if cat_id == cat_names_to_id("ship stern"): #9
        ...
        P = np.array([[x1, y1, z1],[x1, y1, z2],[-x1, y1, z2],[-x1, y1, z1],[x2, y2, z1],[x2, y2, z2],[-x2, y2, z2],[-x2, y2, z1]])
        #print("Pw [{}] : ship stern".format(cat_id))
        return P
    
        
    if cat_id == cat_names_to_id("landing pad"): #10
        x1 = 3.138
        x2 = 3.334 
        y1 = -2.920
        y2 = 2.78
        ...
        P = np.array([[x1, y1, z1],[x1, y1, z2],[-x1, y1, z2],[-x1, y1, z1],[x2, y2, z1],[x2, y2, z2],[-x2, y2, z2],[-x2, y2, z1]])
        #print("Pw [{}] : landing pad".format(cat_id))
        return P



    if cat_id == cat_names_to_id("Mast"): #11
        x1 = 0.152
        x2 = 0.152
        y1 = 3.34081
        y2 = 3.77873
        ...
        P = np.array([[x1, y1, z1],[x1, y1, z2],[-x1, y1, z2],[-x1, y1, z1],[x2, y2, z1],[x2, y2, z2],[-x2, y2, z2],[-x2, y2, z1]])
        #print("Pw [{}] : Mast".format(cat_id))
        return P    

    if cat_id == cat_names_to_id("pelican case"): #12
        x1 = 0.543
        x2 = 0.12
        y1 = 2.37
        y2 = 2.77
        ...
        P = np.array([[x1, y1, z1],[x1, y1, z2],[x2, y1, z2],[x2, y1, z1],[x1, y2, z1],[x1, y2, z2],[x2, y2, z2],[x2, y2, z1]])
        #print("Pw [{}] : pelican case".format(cat_id))
        return P

cat_name_ids = np.array([cat_names_to_id(cat_names[i]) for i in range(len(cat_names))]) #not necessory
